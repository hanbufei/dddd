...
func workflow() {
	...
	if structs.GlobalConfig.CheckPoc != "" {
		api.PocCheck(common.TargetString, structs.GlobalConfig.CheckPoc,structs.GlobalConfig.HTTPProxy)
		return
	}
